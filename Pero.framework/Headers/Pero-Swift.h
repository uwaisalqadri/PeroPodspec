...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Pero",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC4Pero14ChipFlowLayout")
@interface ChipFlowLayout : UICollectionViewFlowLayout
...
SWIFT_CLASS("_TtC4Pero29CollectionViewWaterfallLayout")
...
SWIFT_CLASS("_TtC4Pero24SelfSizingCollectionView")
@interface SelfSizingCollectionView : UICollectionView
...
SWIFT_CLASS("_TtC4Pero19SelfSizingTableView")
...
SWIFT_CLASS("_TtC4Pero29StatusBarNavigationController")
@interface StatusBarNavigationController : UINavigationController
